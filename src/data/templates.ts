...
export const templates: TemplateSection[] = [
  {
    ...
    css: `
      .hero-section { background-color: var(--white); position: relative; overflow: hidden; display: flex; align-items: stretch; min-height: min(860px, 88vh); }
      .hero-section__content-area { flex: 0 0 42%; position: relative; z-index: 10; display: flex; align-items: stretch; padding: 2rem 0; min-width: 0; }
      ...
      .hero-section__image-area { flex: 0 0 58%; position: relative; min-height: min(860px, 88vh); width: 100%; background: #f8fafc; overflow: hidden; min-width: 0; }
      ...
      @media (max-width: 1024px) {
        ...
        .hero-section__image-area { flex: none; min-height: 0; height: 300px; width: 100%; }
        .hero-section__content-area { flex: none; width: 100%; padding: 0; display: block; margin-top: -3rem; position: relative; z-index: 20; }
...
<section class="roadmap-section">
  ...
  },
  {
    ...
    css: `
      ...
      .feature-split__grid { display: flex; align-items: center; gap: clamp(2rem, 5vw, 6rem); }
      .feature-split__img { flex: 1; min-width: 0; } /* min-width: 0 prevents flex child from overflowing */
      .feature-split__content { flex: 1; min-width: 0; }
      ...
      @media (max-width: 1024px) { .feature-split { padding: 4rem 0; } .feature-split__grid { flex-direction: column; gap: 3.5rem; } .feature-split__content { width: 100%; } .feature-split__img { width: 100%; order: -1; } }
    `,
    renderHtml: (v) => {
      const imgBlock = `
  ...
  },
  {
    ...
    css: `
      .feature-split { padding: 7rem 0; overflow: hidden; }
      .feature-split__grid { display: flex; align-items: center; gap: clamp(2rem, 5vw, 6rem); }
      .feature-split__img { flex: 1; min-width: 0; }
      .feature-split__content { flex: 1; min-width: 0; }
      .feature-split__img { position: relative; width: 100%; aspect-ratio: 1 / 1; border-radius: 4px; overflow: hidden; box-shadow: -20px 20px 0px var(--light); }
      .feature-split__img img { width: 100%; height: 100%; object-fit: cover; }
      .feature-split__content h2 { font-size: clamp(2rem, 4vw, 2.75rem); margin-bottom: 2rem; line-height: 1.1; font-weight: 600; }
      .feature-split__content p { font-size: 1.125rem; color: var(--gray); margin-bottom: 3rem; line-height: 1.7; max-width: 32rem; }
      @media (max-width: 1024px) { .feature-split { padding: 4rem 0; } .feature-split__grid { flex-direction: column; gap: 3.5rem; } .feature-split__content { width: 100%; order: 2; } .feature-split__img { width: 100%; order: 1; box-shadow: 20px 20px 0px var(--light); } }
    `,
    renderHtml: (v) => {
      const imgBlock = `
        <div class="feature-split__img">
  ...
  },
  {
    ...
    css: `
      ...
      .project-image-wrapper { flex: 0 0 58%; position: relative; height: 100%; min-height: 450px; width: 100%; overflow: hidden; min-width: 0; }
